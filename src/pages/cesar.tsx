    ...
    <>
      <div className="flex flex-col justify-center items-center space-y-6 h-10/12 mb-3 p-6">
        <div className='mt-5 ml-2 self-start'>
          <Link to="/">
            <button style={{ fontFamily: 'American Typewriter' }} className="font-mono shadow-none hover:shadow-lg bg-transparent dark:hover:underline text-indigo-700 dark:text-white pt-0 px-6 transition-all duration-600">
              ← Retour
            </button>
          </Link>
        </div>
        ...
        <button className="font-mono shadow-sm hover:shadow-md bg-indigo-600 dark:bg-indigo-900 hover:bg-indigo-700 dark:hover:bg-indigo-700 text-white my-6 py-3 px-6 transition-all duration-600" style={{ fontFamily: 'American Typewriter' }} onClick={handleClick}>
          Crypter
        </button>
        <div className="w-11/12 max-w-md mx-auto">
          <label
        ...
        <button className="shadow-sm hover:shadow-md bg-indigo-600 dark:bg-indigo-900 hover:bg-indigo-700 dark:hover:bg-indigo-700 text-white my-6 py-3 px-6 transition-all duration-600" onClick={handleCopy} style={{ fontFamily: 'American Typewriter' }}>
          Copier le résultat
        </button>
        <button className="shadow-sm hover:shadow-md bg-red-600 dark:bg-red-900 hover:bg-red-700 dark:hover:bg-red-800 text-white py-2 px-6 m-6 transition-all duration-600" onClick={handleClear} style={{ fontFamily: 'American Typewriter' }}>
          Effacer le texte
        </button>
      </div>
    </>
