    ...
    <>
      <div className="flex flex-col justify-center items-center space-y-6 h-10/12 mb-3 p-6">
        <div className='mt-5 ml-2 self-start'>
          <Link to="/">
            <button className="font-mono shadow-none hover:shadow-lg bg-transparent dark:hover:underline text-indigo-700 dark:text-white pt-0 px-6 transition-all duration-600" style={{ fontFamily: 'American Typewriter' }}>
              ← Retour
            </button>
          </Link>
        </div>
        <h1 className="font-mono text-indigo-700 dark:text-white text-2xl m-6" style={{ fontFamily: 'American Typewriter' }}>Compteur de caractères</h1>
        ...
        <button className="font-mono shadow-sm hover:shadow-md bg-indigo-600 dark:bg-indigo-900 hover:bg-indigo-700 dark:hover:bg-indigo-700 text-white my-6 py-3 px-6 transition-all duration-600" onClick={handleClick} style={{ fontFamily: 'American Typewriter' }}>
          Compter
        </button>
        <div className="w-11/12 max-w-md mx-auto">
          <label
        ...
        <button className="font-mono shadow-sm hover:shadow-md bg-indigo-600 dark:bg-indigo-900 hover:bg-indigo-700 dark:hover:bg-indigo-700 text-white my-6 py-3 px-6 transition-all duration-600" onClick={handleCopy} style={{ fontFamily: 'American Typewriter' }}>
          Copier le résultat
        </button>
